...
* We talked about improving portolio websites by using bullet points and highlighting important things for a visitor to easily navigate their way through the portfolio.
