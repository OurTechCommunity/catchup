...
* Alpesh demoed a side project which is a Monkeytype trainer focused on cybersecurity commands and short explanations, aimed at muscle memory for shell and tooling workflows.

==== Additional resources and links

* link:https://www.rutgers.edu[Rutgers University^]
* link:https://harrisburg.psu.edu[Penn State Harrisburg^]
* link:https://livekit.com[livekit^]
